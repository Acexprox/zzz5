...
const HomePage = () => {
 ...
 <div className="text-center">
   <div className="inline-block w-full sm:w-auto glass-title-badge text-[#0A2540] px-7 py-8 sm:py-3.5 rounded-2xl sm:rounded-xl text-[2rem] sm:text-[2rem] font-black tracking-tight sm:leading-tight mb-2 sm:mb-6 inline-badge hero-title-badge font-ghayaty transform-none min-h-[90px] sm:min-h-0"
        style={{
          width: '100%',
          height: 'auto',
          display: 'flex',
